...
public class LZW {
    ...
    public void kompresja(File in, File out) throws IOException, IOException, IOException {
        ...
        System.out.println("Dlugosc pliku wejściowego : " + in.length() + " (~" + in.length() / 1024 + "kB)");
        System.out.println("Dlugosc pliku po kompresji : " + out.length() + " (~" + out.length() / 1024 + "kB)");
    ...
    public void dekompresja(File in, File out) throws IOException {
        ...
        close();
        System.out.println("Dlugosc pliku po dekompresji : " + out.length() + " (~" + out.length() / 1024 + "kB)");
    }
